...
(function($) {
    ...
    var $allContentDivs = $('#sampul-konten, #mempelai-konten, #hadir-konten, #acara-konten, #album-konten, #ucapan-konten, #lokasi-konten, #outfit-konten, #cerita-konten, #prokes-konten, #hadiah-konten').hide(); // Hide All Content Divs
    ...
    $('#sampul, #mempelai, #acara, #album, #ucapan, #hadir, #lokasi, #outfit, #cerita, #prokes, #hadiah').click(function(){
