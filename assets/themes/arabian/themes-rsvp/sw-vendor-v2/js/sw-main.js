...
console.clear();
setTimeout(console.log.bind(console, "%cMYCODING.ID WEDDING INVITATION%c", "color:#F2253C;font-size:40px;padding:5px;display:table;width:100%;", ""));
...
setTimeout(console.log.bind(console,"%cLayanan pembuatan undangan pernikahan digital kualitas premium. Undangan pernikahan akan lebih praktis dan kekinian, dengan url undangan yang dapat disebar otomatis ke seluruh kontak WhatsApp, Anda dapat memberikan kesan terbaik untuk momen spesial pernikahan.%c", "color:#333333;font-size:15px;padding:5px;display:table;width:100%;", ""));
