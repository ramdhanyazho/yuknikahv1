          ...
          <form action="<?php echo base_url('order/4') ?>" method="post">
            ...
            <div class="row align-items-center">
              ...
              <div class="col-6">
                ...
                <input name="waktu_akad" type="time" class="form-control" placeholder="Contoh : 10.00 Pagi" value="<?php if(isset($_SESSION['waktu_akad'])) echo $_SESSION['waktu_akad']; ?>" required>
              </div>
            </div>
            ...
            <div class="row align-items-center mt-3">
              <div class="col">
                ...
                <input name="lokasi_akad" type="text" class="form-control" placeholder="Contoh : Kediaman Mempelai Wanita " value="<?php if(isset($_SESSION['lokasi_akad'])) echo $_SESSION['lokasi_akad']; ?>" style='text-transform:capitalize' required>
              </div>
            </div>
           ...
           <a style="color: #2c3e50;margin-bottom:0px;font-size: 20px;font-weight: 600;margin-top: 15px;display: flex;">Resepsi</a>
            ...
            <div class="row align-items-center">
              ...
              <div class="col-6">
                <label>Waktu / Jam</label>
                <input name="waktu_resepsi" type="time" class="form-control" placeholder="Contoh : 10.00 Pagi"value="<?php if(isset($_SESSION['waktu_resepsi'])) echo $_SESSION['waktu_resepsi']; ?>" required>
              </div>
            </div>
            ...
            <div class="row align-items-center mt-3">
              <div class="col">
                <label>Tempat / Lokasi</label>
                <input name="lokasi_resepsi" type="text" class="form-control" placeholder="Contoh : Kediaman Mempelai Wanita" value="<?php if(isset($_SESSION['lokasi_resepsi'])) echo $_SESSION['lokasi_resepsi']; ?>" style='text-transform:capitalize' required>
              </div>
            </div>
              ...
              <div class="col">
                ...
                <div class="mt-1">
                  <label class="form-check-label ">
                      <a href="<?= base_url('maps'); ?>" target="_blank"><i class="fa fa-question-circle"></i>&nbsp Cara Menambahkan Maps</a>
                    </label>
                </div>
              </div>
            </div>
