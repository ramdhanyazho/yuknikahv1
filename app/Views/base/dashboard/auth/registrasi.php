                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="login-form">
                                ...
                                <?php endif ?>
                                <form method="post" action="<?php echo base_url('do_kirim_token'); ?>" class="user">
                                    <div class="form-group">
                                        <input type="text" class="form-control" placeholder="0812345678" name="no_wa">
                                    </div>
                                    <div class="form-group">
                                        <input type="text" class="form-control" placeholder="Password" name="pass_reg">
                                    </div>
