...
<html Content-Language="ID" lang="id" xml:lang="id">
    <head>
        ...
        <meta name="description" content="Undangan digital berupa website dan video untuk pernikahanmu. Lebih praktis, keren dan kekinian.">
        <meta name="author" content="MC Project">
        <link href="<?= base_url('assets/base'); ?>/img/favicon.png?<?= date("Y-m-d"); ?>" rel="icon">
        ...
        <script src="<?= base_url() ?>/assets/base/js/sweetalert2.min.js"></script>
        <link rel="stylesheet" type="text/css" href="<?= base_url() ?>/assets/base/css/sweetalert2.min.css">
        <link rel="stylesheet" href="<?= base_url() ?>/assets/base/css/buttons.dataTables.min.css">
    ...
    <body id="page-top">
        <div id="wrapper">
            ...
            <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseBootstrap" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="<?= base_url('user/rekening'); ?>">Rekening</a>
                        </div>
                    </div>
                </li>
                <li class="nav-item">
                ...
                <hr class="sidebar-divider">
                <div class="version" ><?= SITE_NAME ?> Version <?= SITE_VERSION; ?>. <a href="https://mycoding.id" rel="dofollow" target="_blank">MC Project</a></div>
            </ul>
            <!-- Sidebar -->
