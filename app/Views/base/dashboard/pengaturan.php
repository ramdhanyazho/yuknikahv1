              ...
              <div class="card mb-4">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input id="token_wa" type="text" class="form-control" placeholder="Token Whatsapp Gateway" value="<?= $data[0]->token_wa ?>" required>
                    ...
                    <b>Penting:</b> Agar undangan terkirim otomatis ke semua data tamu, device yang ditambah pada akun nusagateway tidak boleh dihapus, dan statusnya harus CONNECTED.
