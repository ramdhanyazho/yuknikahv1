...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <div class="btn-group">
            ...
            <div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 38px, 0px);">
                ...
                <button class="dropdown-item" data-toggle="modal" data-target="#modalExcel">Import Tamu (Excel)</button>
            </div>
    </div>
</div>
                    ...
                    ?>
                      <tr>
                        ...
                        <td>
                            <button 
                            data-id="<?= $row->id_tamu?>" 
                            class="btn btn-sm btn-success kirim" data-toggle="modal" data-target="#modalKirim">Kirim</button>
                            <button 
                            data-id="<?= $row->id_tamu?>" 
    ...
    <!--Row-->
        ...
        <div class="modal-dialog" role="document">
		    ...
		    <label class="form-check-label ">
                <a href="<?php echo base_url('import_tamu'); ?>" target="_blank" style="margin-top: 105px;color: #2c3e50;position: relative;top:3px;color:#17a2b8;"><i class="fa fa-question-circle" style="color:#17a2b8;"></i>&nbsp Susunan Data Untuk File Data Tamu (Excel)</a>
            </label>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
