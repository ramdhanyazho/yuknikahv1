...
<div class="container-fluid" id="container-wrapper">
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <div>
      ...
      <a href="<?= SITE_BUKUTAMU ?>/<?= $order[0]->domain ?>" target="_blank" class="btn btn-primary btn-sm">Buka Buku Tamu</a>
  ...
  <div class="row mb-3">
    ...
    <div class="col-xl-6 col-lg-6 mb-4">
      <div class="card mb-4">
        ...
        <div class="card-body">
          <p>Buku tamu online ini digunakan sebagai pengganti buku tamu fisik di lokasi pesta / event pernikahan Anda.</p>
          <b>Cara Penggunaan:</b>
          <ul>
            <li>Siapkan komputer yang terkoneksi internet di lokasi pesta</li>
            <li>Buka halaman tamu di <a href="<?= SITE_BUKUTAMU ?>/<?= $order[0]->domain ?>" target="_blank"><b>BUKU TAMU SAYA</b></a> di komputer tersebut</li>
            <li>Tamu membuka undangan dan input QR Code undangan mereka dengan Scan di halaman BUKU TAMU.</li>
            <li>Secara otomatis data tamu (nama dan alamat) akan terisi jika tamu tersebut terdaftar di <a href="<?= SITE_BUKUTAMU ?>/user/tamu" target="_blank"><b>DAFTAR TAMU</b></a></li>
            <li>Setelah buku tamu diisi, daftar tamu yang hadir dapat dilihat pada halaman <a href="<?= SITE_BUKUTAMU ?>/user/data_hadir" target="_blank"><b>DATA KEHADIRAN</b></a></li>
          </ul>
        </div>
      </div>
      <!--Row-->
