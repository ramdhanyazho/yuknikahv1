            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="col mt-2">
                        ...
                        <input id="waktu_akad" type="time" class="form-control" placeholder="Contoh : 10.00 Pagi" value="<?= $acara[0]->jam_akad ?>" required>
                    </div>
        ...
        <div class="col-xl-6 col-lg-6 mb-4">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="col mt-2">
                        <label>Waktu / Jam</label>
                        <input id="waktu_resepsi" type="time" class="form-control" placeholder="Contoh : 10.00 Pagi" value="<?= $acara[0]->jam_resepsi ?>" required>
                    </div>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <label class="form-check-label ">
                      <a href="<?php echo base_url('maps'); ?>" target="_blank"><i class="fa fa-question-circle"></i>&nbsp Cara Menambahkan Maps</a>
                    </label>
                    </div>
                    <div class="col mt-3">
