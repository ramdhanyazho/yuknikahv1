...
<head>
   ...
   <meta property="og:title" content="<?php echo $nama_panggilan_pria." & d".$nama_panggilan_wanita; ?>">
...
<link href="<?php echo base_url() ?>/assets/themes/watercolor1/themes/watercolor1/style.css" rel="stylesheet">
<link rel="stylesheet" href="<?php echo base_url() ?>/assets/themes/watercolor1/themes/style.css">
</head>
      ...
      <section class="full header pt-0 pb-0">
        <div class="container">
            ...
            <div class="col-md-12 header-frame" data-aos="fade-down" data-aos-duration="1000">
                <h1><?php echo $nama_panggilan_pria." <span>&</span> ".$nama_panggilan_wanita; ?></h1>
                <p class="mt-3"><span id="tanggal-weddingnya"><?= $tanggal_resepsi ?></span></p>
            </div>
                    ...
                    <div class="col-md-4 mt-4 information-wrap" data-aos="fade-right">
                        <div class="information">
                            ...
                            <p><span id="tanggal-acara-akad"><?= $tanggal_akad ?></span><br>
                                <?= $jam_akad ?></p>
                                <span class="font-weight-bold"><?= $tempat_akad ?></span><br>
                                <?= $alamat_akad ?>
                        ...
                        <div class="col-md-4 mt-4 information-wrap" data-aos="fade-right"  data-aos-delay="100">
                            <div class="information">
                                ...
                                <p><span id="tanggal-acara-resepsi"><?= $tanggal_resepsi ?><br >
                                   <?= $jam_resepsi ?></p>
                                   <span class="font-weight-bold"><?= $tempat_resepsi ?></span> <br >
                                   <?= $alamat_resepsi ?>
                                   <div class="d-flex justify-content-center mt-4">
                                    <img src=<?php echo base_url() ?>/assets/themes/watercolor1/themes/watercolor1/images/mahkota.png alt="mahkota" style="max-height:30px">
                                </div>
