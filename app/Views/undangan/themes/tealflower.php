						...
						<table class="tb-acara">
							<thead>
								<th colspan="4" class="acara-title">
									<!-- <img src="<?php echo base_url() ?>/assets/themes/tealflower/img/syukuran-badge.png" > --> - TASYAKURAN -
								</th>
							</thead>
							<tbody>
								<tr>
								...
								<table class="tb-acara">
									<thead>
										<th colspan="4" class="acara-title">
											<!-- <img src="<?php echo base_url() ?>/assets/themes/tealflower/img/akad-badge.png"> --> - AKAD NIKAH -
										</th>
									</thead>
									<tbody>
										<tr>
											...
											<table class="tb-acara">
												<thead>
													<th colspan="4" class="acara-title">
														...
														<!-- <img src="<?php echo base_url() ?>/assets/themes/tealflower/img/resepsi-badge.png"> --> - RESEPSI PERNIKAHAN -
													</th>
												</thead>
												<tbody>
													<tr>
