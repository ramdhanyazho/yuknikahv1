		...
		<div class="row d-flex justify-content-center text-center">
			<div class="col-md-4 col-sm-12 col-md-offset-4">
				<div class="salam">
					...
					?></span><br>
					<br>
					<a style="font-weight: bold;font-size: 12px;color: #604e19;position: absolute;right: 0;left: 0;"><button id="buka-undangan" type="button" class="btn btn-success" style="box-shadow: rgba(0, 0, 0, 0.16) 0px 3px 6px, rgba(0, 0, 0, 0.23) 0px 3px 6px;">Buka Undangan</button></a>
				</div>
			</div>
		</div>
	</div>	
