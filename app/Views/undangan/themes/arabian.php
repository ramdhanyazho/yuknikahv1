...
<head>
	...
	<link rel="stylesheet" href="<?php echo base_url() ?>/assets/themes/arabian/themes-rsvp/sw-vendor-v2/css/simplelightbox.min.css">
	<link rel="stylesheet" href="<?php echo base_url() ?>/assets/themes/arabian/themes-rsvp/sw-vendor-v2/arabian/arabian.css">
	<script src="<?php echo base_url() ?>/assets/themes/arabian/themes-rsvp/sw-vendor-v2/js/jquery-3.1.0.min.js"></script>
</head>
...
<body>
	<div id="over-lay-welcome">
		<div class="row" style="margin:0 auto;">
			<div class="col-md-6 col-sm-12 col-md-offset-3">
				...
				<p>Selamat datang di undangan pernikahan Kami.
					<br>Gunakan browser Chrome atau Safari agar website tampil sempurna. Gunakan tombol icon menu di samping atau scroll untuk melihat halaman selanjutnya. </p>
					<br>
		...
		<div class="navbar-mobile text-center">
			<ul>
				<li><a href="#1" class="vs-anchor" title="Beranda"><i class="fa fa-home"></i><p>Home</p></a></li>
				<li><a href="#2" class="vs-anchor" title="Mempelai"><i class="fa fa-user"></i><p>Mempelai</p></a></li>
				<li><a href="#3" class="vs-anchor" title="Resepsi"><i class="fa fa-cutlery"></i><p>Resepsi</p></a></li>
				<?php foreach ($rules->getResult() as $set){ 
					if($set->cerita == 1) { ?>
						<li><a href="#4" class="vs-anchor" title="Story"><i class="fa fa-file-text-o"></i><p>Story</p></a></li>
					<?php }
					if($set->gallery == 1) { ?>
						<li><a href="#5" class="vs-anchor" title="Gallery"><i class="fa fa-camera"></i><p>Gallery</p></a></li>
					<?php }
					if($set->komen == 1) { ?>
						<li><a href="#6" class="vs-anchor" title="Ucapan"><i class="fa fa-comment"></i><p>Ucapan</p></a></li>
					<?php } 
					if($set->qrcode == 1) { ?>
						<li><a href="#" data-toggle="modal" data-target="#sw-qrcode" title="QrCode"><i class="fa fa-qrcode"></i><p>QrCode</p></a></li>
					<?php } 
					if($set->hadiah == 1) { ?>
						<li><a href="#" data-toggle="modal" data-target="#sw-hadiah" title="Hadiah"><i class="fa fa-gift"></i><p>Hadiah</p></a></li>
					<?php } ?>
					<li><a href="#" data-toggle="modal" data-target="#sw-share" title="Bagikan"><i class="fa fa-share-alt"></i><p>Share</p></a></li>
				<?php } ?>
			</ul>
		</div>
		<div class="mainbag">
						...
						<div class="col-md-12">
							<div class="sw-invitation-home text-center">
								<div class="sw-content">
									<h2 class="typewrite" data-period="2000" data-type='[ "The Wedding", "<?php echo $nama_panggilan_pria." & ".$nama_panggilan_wanita; ?>", "Save Date" ]'></h2>
			...
			<section vs-anchor="2" class="mainview sw-mempelai-warpper">
				<div class="vs-center-wrap">
					<div class="sw-content-inner">
						<div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 col-md-offset-2 col-lg-offset-2"><img class="sw-el-top" src="<?php echo base_url() ?>/assets/themes/arabian/themes-rsvp/sw-vendor-v2/arabian/img/sw-element-top.png">
							...
							</div><img class="sw-el-bottom" src="<?php echo base_url() ?>/assets/themes/arabian/themes-rsvp/sw-vendor-v2/arabian/img/sw-element-bottom.png"></div>
						</div>
					</section>
					<section vs-anchor="3" class="mainview sw-akad-resepsi-rapper">
						<div class="vs-center-wrap">
							<div class="container">
								<div class="sw-content-inner">
									<div class="row">
										<div class="sw-ceremony col-xs-12 col-sm-6 col-md-6 col-lg-6">
											<div class="sw-akad-resepsi text-center">
												...
												<h3>Akad Nikah</h3>
												<p><span id="tanggal-acara-akad"><?= $tanggal_akad ?></span>
													<br> Jam <?= $jam_akad ?>
													<br> <?= $tempat_akad ?><br><?= $alamat_akad ?></p>
												</div>
											</div>
											<div class="sw-ceremony col-xs-12 col-sm-6 col-md-6 col-lg-6">
												<div class="sw-akad-resepsi text-center">
													<div class="sw-icon"><span class="flaticon-dinner"></span></div>
													<h3>Resepsi</h3>
													<p><span id="tanggal-acara-resepsi"><?= $tanggal_resepsi ?></span>
														<br> Jam <?= $jam_resepsi ?>
														<br> <?= $tempat_resepsi ?><br><?= $alamat_resepsi ?></p><a href="#" data-toggle="modal" data-target="#sw-maps" title="Lokasi">Buka di google map</a></div>
													</div>
												</div>
											</div>
										</div>
									...
									<?php foreach ($rules->getResult() as $set){ ?>
										<?php if($set->cerita == 1) { ?>
											<section vs-anchor="4" class="mainview sw-story-wrapper" style="background:url('<?php echo base_url() ?>/assets/themes/arabian/themes-rsvp/sw-vendor-v2/arabian/img/cover-prewed.jpg') no-repeat;">
												<div class="over"></div>
												<div class="vs-center-wrap">
													<div class="vs-center">
														<div class="sw-content-inner">
							...
							<div class="modal-dialog" role="document">
								<div class="modal-content modal-md">
									<div class="modal-header">
										...
										<h4 class="modal-title" id="myModalLabel">Buku tamu</h4></div>
										<div class="modal-body">
								...
								<div class="modal-content">
									...
									<div class="modal-body">
										<div class="text-center mb-3">
											<img src=<?php echo base_url() ?>/assets/themes/arabian/themes-rsvp/sw-vendor-v2/arabian/img/love.png alt="donation" style="max-width: 60px;">
										...
										foreach ($rekening->getResult() as $row){ 
											...
											<div class="row">
												<div class="col-12" style="text-align:center">
													...
													<span onClick='copyText(this)'><?= $row->no_rekening ?> <img src=<?php echo base_url() ?>/assets/themes/arabian/themes-rsvp/sw-vendor-v2/arabian/img/copy.png style="height:13px;margin-top:-5px;cursor:pointer"></span><br>
						...
						<script src="<?php echo base_url() ?>/assets/themes/arabian/themes-rsvp/sw-vendor-v2/js/jquery.countdown.min.js"></script>
						<script src="<?php echo base_url() ?>/assets/themes/arabian/themes-rsvp/sw-vendor-v2/js/jquery.easing.min.js"></script>
						<script src="<?php echo base_url() ?>/assets/themes/arabian/themes-rsvp/sw-vendor-v2/js/jquery.mousewheel.min.js"></script>
						<script src="<?php echo base_url() ?>/assets/themes/arabian/themes-rsvp/sw-vendor-v2/js/viewScroller.min.js"></script>
						<script src="<?php echo base_url() ?>/assets/themes/arabian/themes-rsvp/sw-vendor-v2/js/simple-lightbox.min.js"></script>
						<script src="<?php echo base_url() ?>/assets/themes/arabian/themes-rsvp/sw-vendor-v2/js/sw-main.js"></script>
						<script src="<?php echo base_url() ?>/assets/themes/arabian/themes-rsvp/sw-vendor-v2/js/moment-with-locales.js"></script>
						...
						<script src="<?php echo base_url() ?>/assets/themes/arabian/themes-rsvp/sw-vendor-v2/js/jquery.classyqr.js"></script>
						<script>
