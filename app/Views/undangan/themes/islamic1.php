      ...
      <section class="full header">
        <div class="container">
            ...
            <div class="col-md-12">
                ...
                <h4 class="caption mb-3"><span id="tanggal-weddingnya"><?= $tanggal_resepsi ?></span></h4>
                <h1 class="text-secondary" data-aos="fade-up" data-aos-duration="1000"><?php echo $nama_panggilan_pria." <span>&</span> ".$nama_panggilan_wanita; ?></h1>
            </div>
        ...
        <section>
            <div class="container">
                ...
                <div class="row mt-5">
                    <div data-aos="zoom-out" data-aos-delay="200" class="col-md-6 mb-5  order-1 ">
                        <div class="row">
                    ...
                    <div data-aos="zoom-out" data-aos-delay="200" class="col-md-6 mb-5 ">
                        <div class="row">
                            <div class="col-md-12 px-5 couple-ring">
                ...
                <div class="row justify-content-md-center">
                    <div class="col-md-4 mt-4 information-wrap" data-aos="fade-up" data-aos-delay="300">
                        <div class="information">
                            <h3 class="caption text-secondary">Akad Nikah</h3>
                            <p><span id="tanggal-acara-akad"><?= $tanggal_akad ?></span><br>
                                <?= $jam_akad ?></p>
                                <p class="font-weight-bold"><?= $tempat_akad ?><br >
                                    <?= $alamat_akad ?></p>
                                </div>
                            </div>
                            <div class="col-md-4 mt-4 information-wrap" data-aos="fade-up" data-aos-delay="400">
                                <div class="information">
                                    <h3 class="caption text-secondary">Resepsi</h3>
                                    <p><span id="tanggal-acara-resepsi"><?= $tanggal_resepsi ?></span><br >
                                        <?= $jam_resepsi ?></p>
                                        <p class="font-weight-bold"><?= $tempat_resepsi ?><br >
                                            <?= $alamat_resepsi ?></p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <section>
                            <div class="container">
                                ...
                                <div class="col-md-12 pt-4">
                                    ...
                                    <h3 class="caption text-secondary">HR. Ibnu Majah</h3>
                                </div>
