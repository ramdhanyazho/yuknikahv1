            ...
            <div class="col-lg-3 col-md-6 col-xs-12 mt-5">
              <div class="card h-100 p-0">
                ...
                <p class="mt-2 mr-2">
                            ...
                            data-id = "<?= $row->id_theme ?>" data-harga="<?= $row->harga; ?>" data-link="<?= htmlentities($row->url_video); ?>" data-nama="<?= $row->nama_tema; ?>">Edit</button></p>
                <p class="mt-2 mr-2">
...
<!-- Modal -->
        ...
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label>Preview Video Undangan</label><br>
