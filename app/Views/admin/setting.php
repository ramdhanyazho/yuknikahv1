            ...
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input id="host_email" type="text" class="form-control" placeholder="Contoh: mail.401xd.com" value="<?= $setting[0]->host_email ?>" required>
                        <small><i>Kosongkan Jika tidak membutuhkan notifikasi email </i></small>
                    </div>
                    <div class="form-group">
                        <label>Email</label>
                        <input id="email" type="email" class="form-control" placeholder="Email SMTP anda" value="<?= $setting[0]->email ?>" required>
                        <small><i>Kosongkan Jika tidak membutuhkan notifikasi email </i></small>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input id="token_wa" type="text" class="form-control" placeholder="Token Whatsapp Gateway" value="<?= $setting[0]->token_wa ?>" required>
                        <small><i>Kosongkan Jika tidak memiliki Token Whatsapp Gateway atau daftar <a href="https://nusagateway.com" target="_blank" rel="nofollow noreferrer noopener">Klik Disini</a></i></small>
                        <p></p>
                        <b>Panduan Nusagateway</b>
                        <ul>
                          <li>Daftar akun <a href="https://nusagateway.com" target="_blank" rel="nofollow noreferrer noopener">nusagateway.com</a></li>
                          <li>Buka akun, klik menu device</li>
                          <li>Kemudian tambah devide</li>
                            <ul>
                              <li>Pilih paket sesuai kebutuhan</li>
                              <li>Nomor sender masukkan no wa Anda, diawali dengan 62. Contoh: 6282377823390</li>
                              <li>URL webhook masukkan URL utama domain Anda</li>
                              <li>Versi beta / multi devive pilih Yes</li>
                              <li>Set sender notif / auto replay pilih Yes</li>
                              <li>Lalu klik tambah devide</li>
                            </ul>
                          <li>Dibagian daftar device, klik icon scan QR</li>
                          <li>Buka WhatsApp Anda, kemudian tab di titik 3</li>
                          <li>Pilih perangkat tertaut, tekan di tautkan perangkat</li>
                          <li>Scan QR code WhatsApp Anda di nusagateway hingga status CONNECTED</li>
                          <li>Selesai.</li>
                        </ul>
                    </div>
                    <div class="form-group">
